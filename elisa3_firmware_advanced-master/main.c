...
*/
	...
	while(1) {
		...
		switch(currentSelector) {
			...
			case 12:    // Modified to only blink red and blue LEDs
			    switch(demoState) {
			        case 0:
			        ...
			        case 1: 
			            // Toggle Red LED
			            updateRedLed(0);  // Turn Red LED on
			            updateBlueLed(255);   // Ensure Blue LED is off
			            demoState = 2;
			            // Add a delay here if needed, e.g., _delay_ms(500);
			            break;

			        case 2:
			            // Toggle Blue LED
			            updateBlueLed(255); // Turn Blue LED on
			            updateRedLed(0);    // Ensure Red LED is off
			            demoState = 1;
			            // Add a delay here if needed, e.g., _delay_ms(500);
			            break;
			    }
